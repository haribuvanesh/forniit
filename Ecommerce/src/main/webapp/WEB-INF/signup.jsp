...
<td><form:input path="firstname" id = "_ifirstname" pattern="[a-zA-Z]" /></td>
<td><form:errors path="firstname" style="color:red"/></td>
</tr>

<tr>
<td><form:label path="lastname">LASTNAME</form:label></td>
<td><form:input path="lastname" id = "_ilastname" pattern="[a-zA-Z]"/></td>
<td><form:errors path="lastname" style="color:red"/></td>
</tr>

<tr>
<td><form:label path="middlename">MIDDLENAME</form:label></td>
<td><form:input path="middlename" id = "_imiddlename" pattern="[a-zA-Z]"/></td>
